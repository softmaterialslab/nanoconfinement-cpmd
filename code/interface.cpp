...
void INTERFACE::set_up(double salt_conc_in, double salt_conc_left, double salt_conc_right,  int salt_valency_in, int salt_valency_left, int salt_valency_right, double bx, double by, double bz)
{
...
void INTERFACE::put_one_saltion_in_center(vector<PARTICLE>& saltion_in, int pz,int nz, double diameter, vector<PARTICLE>& ion)
{
...
void INTERFACE::put_saltions_leftside(vector<PARTICLE>& saltion_left, int valency, double concentration, double diameter, vector<PARTICLE>& ion)
{
...
void INTERFACE::put_saltions_rightside(vector<PARTICLE>& saltion_right, int valency, double concentration, double diameter, vector<PARTICLE>& ion)
{
