...
void precalculate(INTERFACE& box)
{
  ...
  // precalculations for inner sums for fake forces calculations
   for (unsigned int k = 0; k < L.size(); k++)
	...
	left_gw1Ew1_2 += (-0.5) * box.ed_right * (1- 2*box.em_left ) * L[l].Greens_bar_2[k] * L[l].a;	//gw1Ew1_2
	...
	//left_gw1w1 += left_gw1Ew1_1 + left_gw1Ew1_2 + left_gEw1Ew1_11 + left_gEw1Ew1_22 + left_gEw1Ew1_12;
      	box.leftplane[k].fwiwi.push_back(left_gw1w1 + left_gw1Ew1_1 + left_gw1Ew1_2 + left_gEw1Ew1_11 + left_gEw1Ew1_22 + left_gEw1Ew1_12);
      }

      for (unsigned int l = 0; l < R.size(); l++)
      {
	left_gw1w2 = (-0.5) * box.em_left * (box.em_right - 1) * L[k].Greens_inter[l] * R[l].a;			//gw1w2
	left_gw1Ew2_1 = (-0.5) * box.ed_left * (1- 2*box.em_left ) * L[k].Greens_bar_1_inter[l] * R[l].a;		//gw1Ew2_1
	left_gw1Ew2_2 = (-0.5) * box.ed_right * (1- 2*box.em_left ) * L[k].Greens_bar_2_inter[l] * R[l].a;		//gw1Ew2_2
	left_gEw1Ew2_11 = (-0.5) * box.ed_left * box.ed_left * L[k].Greens_bbar_11_inter[l] * R[l].a;			//gEw1Ew2_11
	left_gEw1Ew2_22 = (-0.5) * box.ed_right * box.ed_right * L[k].Greens_bbar_22_inter[l] * R[l].a;		//gEw1Ew2_22
	left_gEw1Ew2_12 = (-0.5) * 2 * box.ed_left * box.ed_right * L[k].Greens_bbar_12_inter[l] * R[l].a;		//gEw1Ew2_12

	left_gw2w1 = (-0.5) * R[l].a * box.em_right * (box.em_left - 1) * R[l].Greens_inter[k];		//gw2w1
	left_gw2Ew1_2 = (-0.5) * R[l].a * box.ed_right* (1 - 2 * box.em_right ) * R[l].Greens_bar_2_inter[k];	//gw2Ew1_2
	left_gw2Ew1_1 = (-0.5) * R[l].a * box.ed_left* (1 - 2 * box.em_right ) * R[l].Greens_bar_1_inter[k];	//gw2Ew1_1
	left_gEw2Ew1_22 = (-0.5) * R[l].a * box.ed_right* box.ed_right * R[l].Greens_bbar_22_inter[k];		//gEw2Ew1_22
	left_gEw2Ew1_11 = (-0.5) * R[l].a * box.ed_left* box.ed_left * R[l].Greens_bbar_11_inter[k];		//gEw2Ew1_11
	left_gEw2Ew1_12 = (-0.5) * R[l].a *2 *  box.ed_left* box.ed_right * R[l].Greens_bbar_12_inter[k];	//gEw2Ew1_12
	...
	box.leftplane[k].fwiwj.push_back(left_gw1w2 + left_gw1Ew2_1 + left_gw1Ew2_2 + left_gEw1Ew2_11 + left_gEw1Ew2_22 + left_gEw1Ew2_12 +  left_gw2w1 + left_gw2Ew1_2 + left_gw2Ew1_1 + left_gEw2Ew1_22 + left_gEw2Ew1_11 + left_gEw2Ew1_12);
      }
	...
	right_gw2Ew2_2  = (-0.5) * box.ed_right* (1 - 2 * box.em_right ) * R[k].Greens_bar_2[l] * R[l].a;	//gw2Ew2_2
	right_gw2Ew2_2 += (-0.5) * box.ed_right* (1 - 2 * box.em_right ) * R[l].Greens_bar_2[k] * R[l].a;	//gw2Ew2_2
	right_gw2Ew2_1  = (-0.5) * box.ed_left* (1 - 2 * box.em_right ) * R[k].Greens_bar_1[l] * R[l].a;	//gw2Ew2_1
	right_gw2Ew2_1 += (-0.5) * box.ed_left* (1 - 2 * box.em_right ) * R[l].Greens_bar_1[k] * R[l].a;	//gw2Ew2_1
	right_gEw2Ew2_22  = (-1.0) * box.ed_right* box.ed_right * R[k].Greens_bbar_22[l] * R[l].a;		//gEw2Ew2_22
	right_gEw2Ew2_11  = (-1.0) * box.ed_left* box.ed_left * R[k].Greens_bbar_11[l] * R[l].a;		//gEw2Ew2_11
	right_gEw2Ew2_12  = (-1.0) * box.ed_left* box.ed_right * R[k].Greens_bbar_12[l] * R[l].a;		//gEw2Ew2_12
	right_gEw2Ew2_12 += (-1.0) * box.ed_left* box.ed_right * R[l].Greens_bbar_12[k] * R[l].a;		//gEw2Ew2_12

        box.rightplane[k].fwiwi.push_back(right_gw2w2 + right_gw2Ew2_2 + right_gw2Ew2_1 + right_gEw2Ew2_22 + right_gEw2Ew2_11 + right_gEw2Ew2_12);
      }

      for ( unsigned int l = 0; l < L.size(); l++)
      {
	right_gw2w1 = (-0.5) * box.em_right * (box.em_left - 1) * R[k].Greens_inter[l] * L[l].a;			//gw2w1
	right_gw2Ew1_2  = (-0.5) * box.ed_right* (1 - 2 * box.em_right ) * R[k].Greens_bar_2_inter[l] * L[l].a;	//gw2Ew1_2
	right_gw2Ew1_1  = (-0.5) * box.ed_left* (1 - 2 * box.em_right ) * R[k].Greens_bar_1_inter[l] * L[l].a;	//gw2Ew1_1
	right_gEw2Ew1_22 = (-0.5) * box.ed_right* box.ed_right * R[k].Greens_bbar_22_inter[l] * L[l].a;		//gEw2Ew1_22
	right_gEw2Ew1_11 = (-0.5) * box.ed_left* box.ed_left * R[k].Greens_bbar_11_inter[l] * L[l].a;		//gEw2Ew1_11
	right_gEw2Ew1_12 = (-0.5) * 2 *  box.ed_left* box.ed_right * R[k].Greens_bbar_12_inter[l] * L[l].a;		//gEw2Ew1_12

	right_gw1w2 = (-0.5) * L[l].a * box.em_left * (box.em_right - 1) * L[l].Greens_inter[k];		//gw1w2
	right_gw1Ew2_1 = (-0.5) * L[l].a * box.ed_left * (1- 2*box.em_left ) * L[l].Greens_bar_1_inter[k];	//gw1Ew2_1
	right_gw1Ew2_2 = (-0.5) * L[l].a * box.ed_right * (1- 2*box.em_left ) * L[l].Greens_bar_2_inter[k];	//gw1Ew2_2
	right_gEw1Ew2_11 = (-0.5) * L[l].a * box.ed_left * box.ed_left * L[l].Greens_bbar_11_inter[k];		//gEw1Ew2_11
	right_gEw1Ew2_22 = (-0.5) * L[l].a * box.ed_right * box.ed_right * L[l].Greens_bbar_22_inter[k];	//gEw1Ew2_22
	right_gEw1Ew2_12 = (-0.5) * L[l].a * 2 * box.ed_left * box.ed_right * L[l].Greens_bbar_12_inter[k];	//gEw1Ew2_12

     	box.rightplane[k].fwiwj.push_back(right_gw2w1 + right_gw2Ew1_2 + right_gw2Ew1_1 + right_gEw2Ew1_22 + right_gEw2Ew1_11 + right_gEw2Ew1_12 + right_gw1w2 + right_gw1Ew2_1 + right_gw1Ew2_2 + right_gEw1Ew2_11 + right_gEw1Ew2_22 + right_gEw1Ew2_12);
      }
    }
	...
	for (unsigned int l = 0; l < L.size(); l++)
        ...
        //left_gEqEw1_12 += (-1.0) * L[l].Greens_bar_2[k] * 0.5 * 2 *  box.ed_left * box.ed_right * inner_lw_12[l] * L[l].a;
      	...
      	for (unsigned int l = 0; l < R.size(); l++)
        	box.leftplane[k].fwq_2.push_back(((-1.0) * L[k].Greens_inter[l] * (- 0.5) *  box.ed_right * (2 * box.em_left -1) \
    ...
    {
      for (unsigned int l = 0; l < L.size(); l++)
        box.rightplane[k].fwq_1.push_back(((-1.0) * R[k].Greens_inter[l] * (- 0.5) *  box.ed_left * (2 * box.em_right -1) \
...
//	box.leftplane[k].inner_qwi_i.push_back(( -0.5 * box.ed_left) * L[k].ndotGradGreens[l] * L[l].a);
	box.leftplane[k].inner_wiq_i.push_back(L[k].Greens[l] * L[l].a * ( -0.5 * box.ed_left * (1 - 2 * box.em_left)) + L[k].Greens_bar_1[l] * L[l].a * ( -0.5 * 2 * box.ed_left * box.ed_left) + L[k].Greens_bar_2[l] * L[l].a * ( -0.5 * 2 * box.ed_left * box.ed_right));
	}
...
//	box.leftplane[k].inner_qwj_i.push_back((-0.5 * box.ed_left) * L[k].ndotGradGreens_inter[l] * R[l].a);
	box.leftplane[k].inner_wjq_i.push_back( L[k].Greens_inter[l] * R[l].a *(-0.5 * box.ed_left * (1 - 2 * box.em_right))+ L[k].Greens_bar_1_inter[l] * R[l].a * (-0.5 * 2 * box.ed_left * box.ed_left) +  L[k].Greens_bar_2_inter[l] * R[l].a * (-0.5 * 2 * box.ed_left * box.ed_right));
	}
    }
	...
	box.rightplane[k].inner_wjq_i.push_back(R[k].Greens_inter[l]* L[l].a * ( -0.5 * box.ed_right * (1 - 2 * box.em_left )) + R[k].Greens_bar_2_inter[l] * L[l].a * ( -0.5 * 2 * box.ed_right * box.ed_right) + R[k].Greens_bar_1_inter[l] * L[l].a * ( -0.5 * 2 * box.ed_left * box.ed_right));
	}
	...
	box.rightplane[k].inner_wiq_i.push_back(R[k].Greens[l]* R[l].a * (-0.5 * box.ed_right * (1 - 2 * box.em_right)) + R[k].Greens_bar_2[l]* R[l].a * (-0.5 * 2 * box.ed_right * box.ed_right) + R[k].Greens_bar_1[l] * R[l].a * (-0.5 * 2 * box.ed_left * box.ed_right));
	}
    }
